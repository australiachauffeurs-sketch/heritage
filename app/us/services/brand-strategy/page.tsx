...
export default function USBrandStrategyPage() {
  const serviceSchema = { '@context': 'https://schema.org', '@type': 'Service', name: 'US Brand Strategy & Visual Identity for Fashion Brands', serviceType: 'Brand Strategy & Identity Design', provider: { '@type': 'Organization', name: 'Heritage Apparels', url: 'https://www.heritageappreals.com/us' }, description: 'Complete US-market brand identity system — logo, visual identity, retail packaging, Amazon Brand Store, and brand guidelines. USPTO trademark check included.', areaServed: { '@type': 'Country', name: 'United States' }, offers: { '@type': 'Offer', priceCurrency: 'USD', price: '3500', priceSpecification: { '@type': 'PriceSpecification', priceCurrency: 'USD', minPrice: '3500', unitText: 'PROJECT' } } };
